...
const generate = () => {
  ...
  let pages = fs.readdirSync(`${process.cwd()}/src/pages`)
  ...
  fs.writeFileSync(`${process.cwd()}/src/generated/routes.js`, result)
}

generate()

if (watch.includes('-w')) {
  fs.watch(`${process.cwd()}/src/pages`, (event, filename) => {
